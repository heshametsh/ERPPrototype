(() => {
  ...
  const storageKey = "erp-design-lab-basket-side-width-v23";
  const presets = { small: 330, medium: 420, large: 540 };
  ...
  function widthBounds() {
    ...
    const max = Math.max(340, Math.min(620, available - 500));
  ...
  function applyWidth(width, persist = true) {
    ...
    panel?.classList.toggle("is-compact", currentWidth < 470);
